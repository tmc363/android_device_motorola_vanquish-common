...
#adreno
PRODUCT_COPY_FILES += \
	$(LOCAL_PATH)/proprietary/adreno/etc/firmware/vidc_1080p.fw:system/etc/firmware/vidc_1080p.fw \
	$(LOCAL_PATH)/proprietary/adreno/etc/firmware/a225_pfp.fw:system/etc/firmware/a225_pfp.fw \
	$(LOCAL_PATH)/proprietary/adreno/etc/firmware/vidc.b02:system/etc/firmware/vidc.b02 \
	$(LOCAL_PATH)/proprietary/adreno/etc/firmware/a225p5_pm4.fw:system/etc/firmware/a225p5_pm4.fw \
	$(LOCAL_PATH)/proprietary/adreno/etc/firmware/vidc.mdt:system/etc/firmware/vidc.mdt \
	$(LOCAL_PATH)/proprietary/adreno/etc/firmware/a300_pfp.fw:system/etc/firmware/a300_pfp.fw \
	$(LOCAL_PATH)/proprietary/adreno/etc/firmware/vidc.b03:system/etc/firmware/vidc.b03 \
	$(LOCAL_PATH)/proprietary/adreno/etc/firmware/vidc.b00:system/etc/firmware/vidc.b00 \
	$(LOCAL_PATH)/proprietary/adreno/etc/firmware/a300_pm4.fw:system/etc/firmware/a300_pm4.fw \
	...
	$(LOCAL_PATH)/proprietary/adreno/etc/firmware/vidcfw.elf:system/etc/firmware/vidcfw.elf \
	$(LOCAL_PATH)/proprietary/adreno/etc/firmware/vidc.b01:system/etc/firmware/vidc.b01 \
	...
	$(LOCAL_PATH)/proprietary/adreno/lib/libOpenCL.so:system/lib/libOpenCL.so \
	$(LOCAL_PATH)/proprietary/adreno/lib/libc2d2_a3xx.so:system/lib/libc2d2_a3xx.so \
